...
Section 12.5 of the paper, and acts as the staging area for input
...
- **Section 12.5 cross-engine comparison** (DuckDB and Umbra on GCP)
...
Section 12.5.4 explains the per-node hardware correction used to
